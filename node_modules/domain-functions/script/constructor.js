...
exports.toComposable = exports.mdf = exports.makeDomainFunction = exports.fromComposable = exports.dfResultFromcomposable = void 0;
const errors_js_1 = require("./errors.js");
const composable_js_1 = require("./composable/composable.js");
function dfResultFromcomposable(fn) {
    return (async (...args) => {
        const r = await fn(...args);
        return r.success
            ? { ...r, inputErrors: [], environmentErrors: [] }
            : (0, errors_js_1.failureToErrorResult)(r);
    });
}
exports.dfResultFromcomposable = dfResultFromcomposable;
...
function makeDomainFunction(inputSchema, environmentSchema) {
    return function (handler) {
        return fromComposable((0, composable_js_1.composable)(handler), inputSchema, environmentSchema);
    };
}
exports.makeDomainFunction = makeDomainFunction;
exports.mdf = makeDomainFunction;
function toComposable(df) {
    return ((input = undefined, environment = {}) => df(input, environment).then((r) => r.success ? r : (0, errors_js_1.errorResultToFailure)(r)));
}
exports.toComposable = toComposable;
...
exports.fromComposable = fromComposable;
const objectSchema = {
    safeParseAsync: (data) => {
