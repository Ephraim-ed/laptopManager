...
exports.success = exports.sequence = exports.pipe = exports.mergeObjects = exports.mapError = exports.map = exports.error = exports.composable = exports.collect = exports.all = void 0;
...
function composable(fn) {
    return async (...args) => {
        try {
            ...
            return error([(0, errors_js_1.toErrorWithMessage)(e)]);
        }
    };
}
