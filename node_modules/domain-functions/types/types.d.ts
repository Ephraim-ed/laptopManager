import { Failure, Success } from './composable/types.js';
/**
 ...
 */
type UnpackSuccess<F extends DomainFunction> = Extract<UnpackResult<F>, {
    success: true;
}>;
/**
 * Unpacks the data type of a successful domain function.
...
export type { AtLeastOne, ErrorWithMessage, Last, MergeObjs, TupleToUnion, } from './composable/types.js';
export type { DomainFunction, ErrorData, ErrorResult, ParserIssue, ParserResult, ParserSchema, Result, SchemaError, SuccessResult, UnpackAll, UnpackData, UnpackDFObject, UnpackResult, UnpackSuccess, };
