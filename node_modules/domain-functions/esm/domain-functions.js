import { failureToErrorResult, ResultError } from './errors.js';
import * as A from './composable/composable.js';
import { dfResultFromcomposable } from './constructor.js';
import { toErrorWithMessage } from './composable/errors.js';
/**
...
function safeResult(fn) {
    return dfResultFromcomposable(A.composable(fn))();
}
/**
...
function all(...fns) {
    return ((input, environment) => {
        ...
        return dfResultFromcomposable(A.all(...composables))();
    });
}
/**
...
function sequence(...fns) {
    return function (input, environment) {
        ...
        return dfResultFromcomposable(A.sequence(...dfsAsComposable))(input);
    };
}
/**
...
function map(dfn, mapper) {
    return ((input, environment) => dfResultFromcomposable(A.map(A.composable(() => fromSuccess(dfn)(input, environment)), mapper))());
}
/**
